...
const T = {
  en: {
    ...
    hero_line3: "MARKET.",
    hero_sub: "But are you disciplined enough to keep it?",
    hero_body: "EdgeMind is the AI accountability coach that sits between you and your worst trading decisions. Your rules. Your psychology. Enforced every single day.",
    ...
    stat2_v: "4 Categories", stat2_d: "of non-negotiable rules enforced daily",
    stat3_v: "$15/mo", stat3_d: "less than a single prop firm reset",
    feat1_t: "Money Rules", feat1_d: "Daily targets, loss limits, single-trade caps, weekly drawdown protection.",
    feat2_t: "Time Rules", feat2_d: "Trading windows, session limits, news blackouts, mandatory rest days.",
    feat3_t: "Behavior Rules", feat3_d: "Trade caps, consecutive loss stops, no adding to losers, stress protocols.",
    feat4_t: "Identity Rules", feat4_d: "Journaling, weekly reviews, discipline tracking, custom personal rules.",
    ...
    plan1_desc: "Daily structure for the trader building discipline.",
    ...
    plan2_desc: "Active monitoring during your session window.",
    ...
    plan3_desc: "For serious prop traders who can't afford mistakes.",
    plan3_features: ["Everything in Performance", "Priority AI responses", "Unlimited daily check-ins", "Weekly performance review", "Unlimited interactions/day"],
  ...
  es: {
    ...
    hero_line3: "MERCADO.",
    hero_sub: "¿Pero tienes la disciplina para conservarlo?",
    hero_body: "EdgeMind es el coach de IA que se interpone entre tú y tus peores decisiones de trading. Tus reglas. Tu psicología. Aplicadas cada día.",
    ...
    stat2_v: "4 Categorías", stat2_d: "de reglas no negociables aplicadas diariamente",
    ...
    plan1_desc: "Estructura diaria para el trader que construye disciplina.",
    ...
    plan2_desc: "Monitoreo activo durante tu ventana de sesión.",
    ...
    plan3_desc: "Para traders prop serios que no pueden permitirse errores.",
    plan3_features: ["Todo en Rendimiento", "Respuestas IA prioritarias", "Check-ins ilimitados al día", "Revisión semanal de rendimiento", "Interacciones ilimitadas/día"],
  ...
  pt: {
    ...
    hero_line3: "MERCADO.",
    hero_sub: "Mas você tem disciplina suficiente para manter o lucro?",
    hero_body: "EdgeMind é o coach de IA que fica entre você e suas piores decisões de trading. Suas regras. Sua psicologia. Aplicadas todos os dias.",
    ...
    stat2_v: "4 Categorias", stat2_d: "de regras inegociáveis aplicadas diariamente",
    ...
    plan1_desc: "Estrutura diária para o trader que está construindo disciplina.",
    ...
    plan2_desc: "Monitoramento ativo durante sua janela de sessão.",
    ...
    plan3_desc: "Para traders prop sérios que não podem se dar ao luxo de errar.",
    plan3_features: ["Tudo em Performance", "Respostas de IA prioritárias", "Check-ins ilimitados por dia", "Revisão semanal de desempenho", "Interações ilimitadas/dia"],
    ...
    <div style={{ minHeight:"100vh",background:"#080C08",fontFamily:"'DM Sans',sans-serif",color:"#D4F5D4" }}>
      ...
      <div style={{ maxWidth:640,margin:"0 auto 60px",padding:"0 24px" }}>
        <div style={{ background:"#0F150F",border:"1px solid #182818",borderRadius:16,padding:"28px 28px 24px" }}>
          <div style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:20,color:"#F0FFF4",letterSpacing:1,marginBottom:4 }}>💸 THE REAL COST OF BROKEN RULES</div>
            ...
            <div className="up" style={{ background:"#080C08",border:"1px solid #00E67628",borderRadius:10,padding:"16px 20px" }}>
              ...
              <div style={{ textAlign:"center",padding:"12px",background:"#00E67610",borderRadius:8 }}>
                <div style={{ fontSize:13,color:"#00E676",fontWeight:700 }}>
                  EdgeMind costs {Math.round((parseInt(calcLoss)/29)*10)/10}x LESS than your rule breaks.
                </div>
                <div style={{ fontSize:11,color:"#3D6B3D",marginTop:4 }}>
                  If it prevents even 1 revenge trade per week, it pays for itself {Math.round(parseInt(calcLoss)/29)}× over.
                </div>
              </div>
      ...
      <div style={{ maxWidth:960,margin:"0 auto 80px",padding:"0 24px" }}>
        <div style={{ textAlign:"center",marginBottom:32 }}>
          <div style={{ fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(28px,5vw,48px)",color:"#F0FFF4",letterSpacing:2,marginBottom:6 }}>REAL TRADERS. REAL RESULTS.</div>
          <div style={{ fontSize:13,color:"#3D6B3D" }}>What happens when traders finally get accountable.</div>
        </div>
    ...
    <div style={{ height:"100vh",background:"#080C08",display:"flex",flexDirection:"column",fontFamily:"'DM Sans',sans-serif",overflow:"hidden" }}>
      ...
      {activeTab==="coach" && <>
        ...
        <div style={{ padding:"10px 18px 16px",flexShrink:0 }}>
          ...
          <div style={{ textAlign:"center",marginTop:6,fontSize:10,color:"#111C11" }}>The rules were made by the calm version of you. Trust them.</div>
        </div>
      </>}
